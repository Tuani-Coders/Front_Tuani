...
// Helper to load and migrate local storage data with initial mock images and fields
const loadAndMigrate = (key, initialData) => {
  ...
  try {
    ...
    return parsed.map(item => {
      ...
      if (match) {
        // Merge so new fields like 'content' and 'additionalImages' are preserved, but keep user edits on other fields
